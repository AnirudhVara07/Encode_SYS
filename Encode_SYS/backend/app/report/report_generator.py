...
def _derive_improvements_text(
    ...
    # Safety framing.
    safety = (
        f"Stop-loss guardrail was enforced at {stop_loss_pct}% from entry, and position sizing was capped at {btc_size} BTC per trade in the simulator."
    )
    ...
    return (
        ...
        f"Parameter updates: {param_changes}. "
